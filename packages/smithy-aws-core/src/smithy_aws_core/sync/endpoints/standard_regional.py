...
from smithy_core.sync.interfaces import EndpointResolver

from ...endpoints import REGIONAL_ENDPOINT_CONFIG


class StandardRegionalEndpointsResolver(EndpointResolver):
    """Resolves endpoints for services with standard regional endpoints (sync)."""
